...
export default function UseCaseSection({useCases}: UseCaseSectionProps) {
    ...
    return (
        <section className='relative w-full h-screen flex flex-col gap-5 items-center justify-center bg-grain overflow-hidden'>
            {/* 배경 */}
            {bgImage && (
            ...
            {/* 헤더 */}
            <div className='max-w-7xl w-full flex justify-between items-end'>
            ...
            <div className='w-full flex gap-20'>
                <div ref={scrollRef} className={cn(
                                                'flex-1 flex gap-5 items-center overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-5',

...
import { ProductLineDTO, IndustryProductsDTO, ProductItemDTO} from '@/types/respDto'

interface ProductContainerProps {
    list: ProductLineDTO[] | IndustryProductsDTO[]
...
export default function ProductContainer({ list, type='normal' }: ProductContainerProps) {
    return (
        <div className='mx-auto max-w-7xl px-5 md:px-10 lg:px-20 py-15 md:py-20'>
            {list.map((item: ProductLineDTO | IndustryProductsDTO ) => (

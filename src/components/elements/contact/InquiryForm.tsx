...
export default function InquiryForm({ productName, policy }: InquiryFormProps) {
    ...
    return (
        <form onSubmit={handleFormSubmit} className='flex flex-col gap-10 md:gap-16'>
            ...
            <PolicySection ref={agreeRef} isAgreed={isAgreed} setIsAgreed={setIsAgreed} policy={policy}/>

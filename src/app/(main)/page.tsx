...
import { INDUSTRY_LIST_QUERY, PRODUCT_LINE_LIST_QUERY, USE_CASES_QUERY} from '@/lib/queries';
...
import { IndustryListDTO, ProductLineListDTO, UseCaseDTO } from '@/types/respDto';
